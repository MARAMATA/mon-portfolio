    ...
    >
      ...
      >
        ...
        <p className="mb-4" style={{ textAlign: "center" }}>
          Grâce à mon expertise en intelligence artificielle et en réglementation douanière, j'aide à améliorer la <strong>gestion des flux commerciaux</strong>, la <strong>conformité</strong> et la <strong>détection des fraudes</strong> grâce à des solutions basées sur la <strong>Data science et l’IA</strong>.
        </p>
